    ...
    local custom_themes = {
      tokyonight = {
        custom_colorscheme = {
          ...
          IlluminatedWordText        = { bg = "#0c1c2c" },
          IlluminatedWordRead        = { bg = "#0c1c2c" },
          IlluminatedWordWrite       = { bg = "#0c1c2c" },
          LspReferenceRead           = { bg = "#2c0c1c" },
          LspReferenceText           = { bg = "#2c0c1c" },
          LspReferenceWrite          = { bg = "#2c0c1c" },
