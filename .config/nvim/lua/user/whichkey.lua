...
local mappings = {
  ...
  g = {
    ...
    -- L = { ":lua vim.cmd[[tabnew|terminal lazygit]] vim.cmd[[set ft=tab-terminal ]] <CR>", "Tab Lazygit" },
    -- L = { "<cmd>tab terminal lazygit<cr><cmd>set ft=tab-terminal<cr>", "Tab Lazygit" },
  ...
  p = {
    ...
    c = { "<cmd>Lspsaga incoming_calls<cr>", "Peek Definition" },
    C = { "<cmd>Lspsaga outgoing_calls<cr>", "Peek Definition" },
