...
#audio_player="setsid mpv --no-video "
#audio_player="nohup mpv --no-video "
#audio_player="tmux new-session setsid -f mpv --no-video "
#audio_player="tmux new-session mpv --no-video "
#audio_player="tmux new-session mpv --no-video $@ "
#audio_player="tmux new-session mpv --no-video %s "
#audio_player="tmux new-session -d mpv --no-video "
#audio_player="(exec </dev/tty; exec <&1; TMUX= tmux new mpv --no-video $@ )"
audio_player="tmux-tty mpv --no-video "
